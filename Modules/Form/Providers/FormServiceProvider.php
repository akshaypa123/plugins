...
class FormServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadMigrationsFrom(module_path('Form', 'Database/Migrations'));
    }
    ...
    {
        $this->publishes([
            module_path('Form', 'Config/config.php') => config_path('form.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Form', 'Config/config.php'), 'form'
        );
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Form', 'Database/factories'));
        }
    }
